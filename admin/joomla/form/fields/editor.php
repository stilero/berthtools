<?php
/**
 * @version		$Id: editor.php 96 2011-08-11 06:59:32Z michel $
...
class JFormFieldEditor extends JFormField
{
	...
	protected function getInput()
	{
		...
		return $editor->display($this->name, htmlspecialchars($this->value, ENT_COMPAT, 'UTF-8'), $width, $height, $cols, $rows, $buttons,array('id'=>$this->id));
